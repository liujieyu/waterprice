	...
	<div>
		<Content class="searchcon">
            <el-table
                ...
                ></el-table-column>
                 <el-table-column label="一级节约用水" align="center">
                    <el-table-column
                    prop="onestandard"
                    label="范围"
                    align="center"
                ...
                <el-table-column label="二级节约用水" align="center">
                    <el-table-column
                    prop="twostandard"
                    label="范围"
                    align="center"
                ...
                <el-table-column label="三级节约用水" align="center">
                    <el-table-column
                    prop="thrstandard"
                    label="范围"
                    align="center"
...
export default {
        ...
        methods:{
            ...
            Headload(){
              ...
              this.axios.get('/'+this.$WarmTable+'/waterprice/getfarmabackstand').then(res => {
            ...
            Reload(){
                ...
                this.axios.get('/'+this.$WarmTable+'/waterprice/getfarmbackwater',{params:paramobj}).then(res => {
                      this.loading=false; 
