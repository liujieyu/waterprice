...
export default {
        ...
        methods:{
            ...
            Headload(){
              ...
              this.axios.get('/'+this.$WarmTable+'/waterprice/getcanalabovestand').then(res => {
            ...
            Reload(){
                ...
                this.axios.get('/'+this.$WarmTable+'/waterprice/getcanalabovewater',{params:paramobj}).then(res => {
                      this.loading=false; 
                      var datalist=res.data;
