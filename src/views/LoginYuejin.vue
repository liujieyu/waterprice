    ...
    <div id="login" class="m-bgImage" style="width: 100%; height: 100vH;">
        ...
        <div class="m-cover">
            <div style="padding: 6em; box-sizing: border-box; text-align: center;">
                <h1 style="font-size: 3.8em;font-weight: 400;color: #FFF;">跃进水协会智慧水价信息管理平台</h1>
            </div>
            ...
            <p style="font-size: 12px; color: #fff; margin: 2em; text-align: center;">2023 © 跃进水协会智慧水价信息管理平台 版权所有</p>
        </div>
        ...
        methods: {
            RouterLink() {
                ...
                if (this.form.pwd==''||this.form.pwd.length<4) {
                    ...
                    this.axios.get('/'+this.$WarmTable+'/waterprice/checkloginname',{params:{loginname:this.form.acc,loginpass:this.form.pwd,showsign:"YJ"}}).then((res)=>{
                        console.log(res);
                        if (res.data.errcode == 400) {
                            ...
                            this.Cook.set("channelcode","V103000000");
                            this.Cook.set("channelname","跃进干渠");
                            this.Cook.set("usertype","YJ");
                            this.Cook.set("title","跃进水协会");
                            this.Cook.set("loginurl",'/loginyuejin');
